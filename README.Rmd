...
- **25 crops** (alfalfa, barley, canola, chickpeas, corn, cotton, crambe, dry beans, dry peas, flaxseed, grain sorghum, lentils, millet, mustard, oats, peanuts, rapeseed, rice, rye, safflower, sesame, soybeans, sunflower, triticale, wheat) -- the ARC/PLC covered commodities plus alfalfa, dry beans, millet, rye, and triticale, which are used by other FSA programs
- **Years: 2013-2026**
...
For each crop year the data reflect FSA's most recent acreage release. Crop years 2013-2025 use the final January release; crop year 2026 uses the in-season release dated September 11, 2026, so 2026 acres are preliminary and will be revised.
